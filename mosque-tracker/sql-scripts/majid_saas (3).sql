...
--
-- Host: localhost:3306
-- Generation Time: Feb 15, 2026 at 06:03 AM
...
(1, 'visit-request', 'Visit Request', 'Request For Visit', 'Request For Visit – {masjid_name}', '<p>Assalamualaikum Warahmatullahi Wabarakatuh,</p>\n\n<p>Dear {contact_name},</p>\n\n<p>In Shaa Allah this message finds you well and having a blessed day.</p>\n\n<p>My name is <strong>{user_name}</strong> and I\'m reaching out on behalf of <strong>{organization.name}</strong>. We are an exclusive project supporting the prison Dawah and our brothers and sisters who are in prisons.</p>\n\n<p>There are many people in prison reverting to Islam, Alhamdulillah. But we cannot do this work without the support of our Muslim communities.</p>\n\n<p>I am sure you get many letters at your Masjid from people in prison — maybe you have volunteers to read them and send the items they ask for. We do this everyday, nationally, and receive about 400 letters a month. We send Islamic books, prayer rugs, and work to get community volunteers approved to go inside prisons to provide Islamic services like Jummah Khutbahs and Islamic support. Prison Chaplains are always asking for more Muslims to visit them inside.</p>\n\n<p>Would you be so kind and grant us an opportunity to come to <strong>{masjid_name}</strong> for a Jumu\'ah Khutbah with an appeal? It is not a fundraiser, but rather an announcement with a table set-up to share our project with your community and raise financial support.</p>\n\n<p>We support all prisons in the U.S. — State, Federal, Jails, and Detention Centers. We are building relationships with both Masjids and Prison Chaplains to get more Muslims involved in volunteering to provide Islamic support in their local communities.</p>\n\n<p>In Shaa Allah, would you grant us a Friday Khutbah for Islam in Prison?</p>\n\n<p>Please let us know what dates and times work best for you, and we will confirm the details. We are flexible on timing and happy to work around your schedule.</p>\n\n<p>Peace & Blessings,</p>\n\n<p style=\"margin:0 0 4px 0; padding:0; font-size:20px; font-weight:600; color:#0f293f; letter-spacing:-0.3px;\">\n        <strong>{user_name}</strong>\n    </p>\n\n    <!-- phone + email line (separator ·) -->\n    <p style=\"margin:4px 0 6px 0; padding:0; font-size:15px; color:#2e475d;\">\n        <span style=\"color:#1e3b4f;\">  {user_phone}</span> \n        <span style=\"color:#8a9fb0; font-weight:400; margin:0 6px;\">·</span> \n        <span style=\"color:#1e3b4f;\">  {user_email}</span>\n    </p>\n\n    <!-- organisation link (no bullet, subtle underline) -->\n    <p style=\"margin:6px 0 0 0; padding:0; font-size:15px;\">\n        <a href=\"{organization.website}\" style=\"color:#20649b; text-decoration:none; border-bottom:1px dashed #9bb7d4; font-weight:450;\">\n            {organization.name}\n        </a>\n    </p>', NULL, '[\"masjid_name\", \"contact_name\", \"user_name\", \"organization.name\", \"user_phone\", \"user_email\", \"website\"]', 1, 1, '2026-02-01 22:00:04', '2026-02-15 05:40:09'),
...
(1, NULL, 'Masjid Abu Bakr', 'Iman Jodeh', 'Omar.Aldawud@gmail.com', '720-608-1882', 1, 1, '2071 S Parker Rd', 'Denver', 'CO', '80231', '(303) 696-9800', 'info@coloradomuslimsociety.org', 'https://coloradomuslimsociety.org', NULL, '', '', 'https://coloradomuslimsociety.org/wp-content/uploads/2018/03/cms-header-1-1024x94.gif', 'https://coloradomuslimsociety.org/donate/', 'https://coloradomuslimsociety.org', '2026-01-31 12:19:29', '2026-02-13 21:55:31'),
...
(6, NULL, 'Colorado Muslim Society', NULL, 'omar.aldawud@gmail.com', '303-696-9800', 1, 1, '2071 S Parker Road', 'Denver', 'CO', '80231', '303-696-9800', 'info@coloradomuslimsociety.org', 'https://coloradomuslimsociety.org/', NULL, NULL, NULL, NULL, 'https://coloradomuslimsociety.org/donate/', NULL, '2026-02-13 00:47:07', '2026-02-13 02:28:10'),
...
(173, NULL, 'Lincoln Islamic Center', 'Ahmed Ali', 'contact@lincolnic.org', '402-555-1001', 1, 1, '123 N 27th St', 'Lincoln', 'NE', '68510', '402-555-1000', 'info@lincolnic.org', 'https://lincolnic.org', 'https://facebook.com/lincolnic', 'https://wa.me/4025551001', NULL, NULL, NULL, NULL, '2026-02-13 22:02:43', '2026-02-13 22:02:43'),
(174, NULL, 'Omaha Masjid', 'Fatima Hassan', 'contact@omahammasjid.org', '402-555-2002', 1, 1, '456 S 24th St', 'Omaha', 'NE', '68105', '402-555-2000', 'info@omahammasjid.org', 'https://omahammasjid.org', 'https://facebook.com/omahammasjid', 'https://wa.me/4025552002', NULL, NULL, NULL, NULL, '2026-02-13 22:02:43', '2026-02-13 22:02:43'),
(175, NULL, 'Cheyenne Islamic Center', 'Mohammed Khan', 'contact@cheyenneic.org', '307-555-3003', 1, 1, '789 W Lincolnway', 'Cheyenne', 'WY', '82001', '307-555-3000', 'info@cheyenneic.org', 'https://cheyenneic.org', 'https://facebook.com/cheyenneic', 'https://wa.me/3075553003', NULL, NULL, NULL, NULL, '2026-02-13 22:02:43', '2026-02-13 22:02:43'),
(176, NULL, 'Salt Lake City Islamic Center', 'Aisha Patel', 'contact@slcic.org', '801-555-4004', 1, 1, '1010 S Main St', 'Salt Lake City', 'UT', '84101', '801-555-4000', 'info@slcic.org', 'https://slcic.org', 'https://facebook.com/slcic', 'https://wa.me/8015554004', NULL, NULL, NULL, NULL, '2026-02-13 22:02:43', '2026-02-13 22:02:43');
...
CREATE TABLE `outreach_logs` (
  ...
  `event_khateeb` varchar(50) DEFAULT NULL,
...
INSERT INTO `outreach_logs` (`id`, `mosque_id`, `user_id`, `contacted_by_org_id`, `method`, `contacted_person_name`, `contacted_person_phone`, `contacted_person_email`, `notes`, `result`, `is_agreed`, `agreed_date`, `event_type`, `event_khateeb`, `event_address`, `contacted_at`) VALUES
(1, 1, 2, 1, 'phone', 'Omar Aldawud', '16308008077', 'oaldawud@clarku.edu', '', 'booked jummeh', 1, '0000-00-00', 'jummeh', 'Br. Jay', 'colorado', '2026-01-31 07:46:41'),
(18, 2, 2, 1, 'visit', 'Omar Aldawud', '16308008077', 'Omar.Aldawud@gmail.com', '', '', NULL, NULL, NULL, NULL, NULL, '2026-02-01 15:31:52'),
(26, 1, 2, 1, 'phone', '', '', '', '', 'booked', 1, '2026-02-13', 'Night Program', 'br omar', 'Colorado, for colonies ', '2026-02-12 16:32:28'),
(27, 1, 2, 1, 'phone', '', '', '', '', 'Booked', 1, NULL, NULL, NULL, NULL, '2026-02-12 16:40:57'),
(28, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Queued (dry run)', NULL, NULL, NULL, NULL, NULL, '2026-02-12 19:12:40'),
(29, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-12 21:22:54'),
(30, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-12 21:23:18'),
(31, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-12 21:23:58'),
(32, 1, 2, 1, 'phone', 'Omar Aldawud', '6308008077', 'omar@rushrash.com', '', 'wow', 1, '2026-02-13', 'Jummah', 'br tom', 'india', '2026-02-12 21:28:26'),
(33, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-12 21:52:21'),
(34, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-12 21:58:27'),
(35, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-12 22:07:17'),
(36, 1, 2, 1, 'Email', 'Iman Jodeh', '720-608-1882', 'Omar.Aldawud@gmail.com', 'Template: Visit Request | Subject: Request For Visit – Masjid Abu Bakr', 'Email Sent', NULL, NULL, NULL, NULL, NULL, '2026-02-13 08:06:10'),
(37, 1, 3, NULL, 'email', 'Omar Aldawud', '6308008077', 'Omar.Aldawud@gmail.com', 'sxs', '', 1, '2026-02-22', 'Jummah', 'omar', 'Nebraska', '2026-02-14 07:03:44'),
(38, 175, 2, 1, 'phone', 'Omar Aldawud', '6308008077', 'Omar.Aldawud@gmail.com', '', 'booked jummeh', 1, '2026-02-14', 'Jummah', 'Ali Abu Lehiea', 'WY', '2026-02-14 21:49:22');
...
(1, NULL, NULL, 'Omar A.', 'system_admin', '', 'sysadmin@example.com', '', '$2y$10$yHOtUIW7U5codj3RwAWBz.gTy6ZqJvJwAx2hWFrdknJ.zXRTZTkH6', 1, 1, 0, NULL, '2026-02-15 06:02:27', '2026-01-31 14:29:34'),
(2, 1, NULL, 'Sr. Fatima', 'organization_admin', 'https://islaminprison.org/wp-content/uploads/2024/11/IslamInPrison-logo-Final.png', 'Fatima.M@Islaminprison.org', '+1(630) 815-7505', '$2y$10$yHOtUIW7U5codj3RwAWBz.gTy6ZqJvJwAx2hWFrdknJ.zXRTZTkH6', 1, 1, 0, NULL, '2026-02-14 21:48:02', '2026-01-31 14:29:34'),
(3, NULL, 1, 'Mosque Admin', 'mosque_admin', 'https://coloradomuslimsociety.org/wp-content/uploads/2018/03/cms-header-1-1024x94.gif', 'mosqueadmin@example.com', '', '$2y$10$yHOtUIW7U5codj3RwAWBz.gTy6ZqJvJwAx2hWFrdknJ.zXRTZTkH6', 1, 1, 0, NULL, '2026-02-14 06:23:54', '2026-01-31 14:29:34'),
