...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    try {
        ...
        if ($organization['guidelines']) {
            $organization['guidelines'] = json_decode($organization['guidelines']);
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
    ...
    try {
        ...
        if (isset($data['guidelines']) && is_array($data['guidelines'])) {
            $data['guidelines'] = json_encode($data['guidelines']);
        }
    ...
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO organizations (
                ...
                logo_url, tagline, mission_statement, description, talking_points, guidelines,
